...
elect name, email from students;
 --7. Вывести id, имя, email и дату создания пользователей
select id, name, email, created_on from students;
 --8. Вывести пользователей где password 12333
select name, password from students where password like '12333';
...
select name, created_on from students where created_on='2021-07-12 00:00:000';
 --14. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и имеют пароль 1m313
select name, created_on, password from students where created_on='2021-07-12 00:00:000' and password='1m313';
...
select name, password from students where password like '12333' or password like '1m313' or password like '123313';
